  ...
  function create (docs, fn) {
    ...
    if(keep && numDocs>0){
      try{
        ...
        var value1 = "血糖持续监测";
        var value2 = (docs[numDocs-1].sgv/18).toFixed(1);
        
        var pushUrl = process.env['PUSH_URL']
        var url = pushUrl+'?value1=' + encodeURIComponent(value1) + '&value2=' + encodeURIComponent(value2) + '&value3=' + encodeURIComponent(key) + '&value4=' + encodeURIComponent(process.env['uid'])
